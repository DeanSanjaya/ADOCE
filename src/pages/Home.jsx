  ...
  return (
    <>
      ...
      <div className="bg-[#8EACCD] min-h-screen">
        ...
        <div className="bg-image-container1 md:p-24 mt-12 py-12 p-2">
          <div className="relative">
            <p className="text-[65px] md:text-[105px] font-bold blur-sm text-blue-400 inline">
              ADOCE
            </p>
            <p className="absolute  inset-0 md:text-[100px] text-[60px] font-bold font-Poppins font-Poppins">
              ADOCE
            </p>
          </div>
        ...
        <div className="flex justify-center flex-wrap mx-20">
          <p className="flex font-inter text-6xl mt-12">Cat Pet</p>
        </div>
        ...
        <div className="bg-image-container p-12 w-full mt-12" id="home">
          <div className="font-baloo md:text-6xl text-3xl font-extrabold md:w-2/4 w-full">
            Prepare Your Home For Your Cat
          </div>
          <p className="md:w-2/4 w-full md:text-3xl text-xl mt-12">
          ...
          <Link to="/adopt">
            <button className="md:text-3xl text-xl bg-[#D9D9D9] hover:bg-white rounded-lg mt-12 p-4">
              Selengkapnya
            </button>
          </Link>
        </div>
      ...
      <div className="container p-12 bg-[#8EACCD] min-w-full mt-2">
        <div className="flex justify-center">
          <p className="text-3xl text-center text-white px-[15%] font-Poppins">
      ...
      {/* ============ */}
      <div className="container p-12 bg-[#8EACCD] min-w-full mt-2">
        <div className="text-3xl font-bold text-white flex justify-center font-Poppins text-5xl">
